...
const XiaomiSection = () => {
    return (
        <>
            ...
            <section className="m-[9px] md:my-0 md:px-2 md:flex md:justify-evenly md:hover:cursor-pointer md:w-full sm:w-full md:max-h-[492px]">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2 md:mt-0 md:max-h-[492px] md:w-full md:mr-2 md:px-0">
                    <ShortCard classname="px-0" Title="Xiaomi 12 Pro" Specs="Ori Grade triple 50MP Camera | Snapdragon® Gen 1" StartingPrice="6.999.000" PhonePic="/public/smartphone/3amobile.webp" Button="md:my-[14px] md:flex md:gap-1"></ShortCard>
                    <ShortCard classname="px-0" Title="Xiaomi 12T 5G" Specs="Ultra Stable 108MP Main Camera with OIS" StartingPrice="5.999.000" PreviousPrice="Rp 6.599.000" Discount="9%" DiscountBorder="text-[#ff6900] border border-[#ff6900]" PhonePic="/public/smartphone/3bmobile.webp" Button="md:my-[14px] md:flex md:gap-1"></ShortCard>
                </div>
            </section>
        </>
    );
