  ...
  return (
    <>
      ...
      <section className="m-[9px] md:my-0 md:px-2 md:flex md:justify-evenly md:hover:cursor-pointer md:w-full sm:w-full md:max-h-[492px]">
        <LongCard
          Title="Xioami 12"
          Specs="50MP Pro-grade camera | Snapdragon® 8 Gen 1"
          Discount="Diskon 30%"
          CurrentPrice="6.999.000"
          PreviousPrice="Rp9.999.000"
          classname="md:bg-[#D0D0D0] md:text-white"
          Status="Habis"
          PhonePic="/public/smartphone/2mobile.webp"
        ></LongCard>
        ...
        <div className="grid grid-cols-2 gap-2 mt-2 md:mt-0 md:max-h-[492px] md:w-full md:mr-2 md:px-0">
          <ShortCard
            ...
            StartingPrice="6.999.000"
            PhonePic="/public/smartphone/3amobile.webp"
